...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distribution in livingGhostPositionDistributions:
            maxDistribution.append(distribution.argMax())

        goalPosition = None
        goalDistance = None
        for currentPosition in maxDistribution:
            ghostDistance = self.distancer.getDistance(pacmanPosition, currentPosition)
            if goalDistance == None:
                goalPos = currentPosition
                goalDistance = ghostDistance
            else:
                if ghostDistance < goalDistance:
                    goalPos = currentPosition
                    goalDistance = ghostDistance
        ...
        for action in legal:
            ...
            actions.append((action, successorDistance))
